          ...
          >
            ...
            {step === 1 && (
              <div className="bg-white rounded-[28px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white/70 flex flex-col gap-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-[22px] font-black text-[#0A0A0A]" style={{ fontFamily: "var(--font-heading)" }}>
                      Go to Provider ðŸï¸
                    </h2>
                ...
                <div className="bg-yellow-50 border border-yellow-100 rounded-2xl p-3 flex items-center gap-3">
                  ...
                  <p className="font-body text-[13px] text-[#5A4A00]">
              ...
              <div className="bg-white rounded-[28px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white/70 flex flex-col gap-5">
                ...
                {!pickupPhotoTaken ? (
                  ...
                  >
                    ...
                    <span className="font-heading font-bold text-[#43A047] text-[16px] relative z-10">âœ… Photo Verified</span>
                    <span className="font-body text-[12px] text-[#1A4A1A] font-bold relative z-10">{activeMission.servings} meals confirmed</span>
                  </motion.div>
                )}

                <div className="bg-green-50 border border-green-100 rounded-2xl p-3 flex items-center gap-3">
                  <span className="text-2xl">ðŸŽ¯</span>
                  <p className="font-body text-[13px] text-[#1A4A1A]">
            ...
            {step === 3 && (
              <div className="bg-white rounded-[28px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white/70 flex flex-col gap-5">
                ...
                <div className="bg-yellow-50 border border-yellow-100 rounded-2xl p-4 flex items-center gap-3">
                  ...
                  <p className="font-body text-[13px] text-[#5A4A00]">
                    <strong>{activeMission.servings} kids</strong> at {activeMission.ngoName.split(' ')[0]} are waiting and excited for this meal! ðŸŽ‰
                  </p>
                </div>
              </div>
            )}
            ...
            {step === 4 && (
              <div className="bg-white rounded-[28px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white/70 flex flex-col items-center text-center gap-5">
                ...
                <div>
                  <h2 className="text-[24px] font-black text-[#0A0A0A]" style={{ fontFamily: "var(--font-heading)" }}>
                    Confirm Delivery! âœ…
                  </h2>
                ...
                {!deliveryPhotoTaken ? (
                  ...
                  >
                    ...
                    <span className="font-heading font-bold text-[#43A047] text-[15px] relative z-10">Delivery Photo Uploaded!</span>
                  </motion.div>
                )}

                <div className="w-full bg-orange-50 border border-orange-100 rounded-2xl p-4 text-left">
                  <p className="font-heading font-bold text-[15px] text-[#E65100]">Mission Summary</p>
                  <div className="flex justify-between mt-2">
                    <span className="font-body text-[13px] text-[#4A4A4A]">Meals delivered</span>
                    <span className="font-heading font-bold text-[#0A0A0A]">{activeMission.servings} meals</span>
                  </div>
                  <div className="flex justify-between mt-1">
                    <span className="font-body text-[13px] text-[#4A4A4A]">Points to earn</span>
                    <span className="font-heading font-bold text-[#E65100]">+100 pts â­</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <AnimatePresence mode="wait">
            {loading ? (
              ...
              <motion.span
                ...
                className="block"
              >
                {step === 1 && "âœ… I've Arrived at Provider"}
                {step === 2 && "ðŸ“¸ Confirm Pickup"}
                {step === 3 && "ðŸ« I've Arrived at NGO"}
                {step === 4 && "ðŸŽ‰ Confirm Delivery!"}
              </motion.span>
            )}
          </AnimatePresence>
        </motion.button>
